...
<body>
	...
	<div class="container"><h1>Informacion del usuario</h1>
		...
		<div class="container">
			<div class="row text-center justify-content-end p-2">
				<a href="eliminar_usuario.php" class="btn btn-danger mr-2">Eliminar</a>
				<a href="editar_usuario.php" class="btn btn-success mr-2">Editar</a>
			</div>
		</div>
	</div>
